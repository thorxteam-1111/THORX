...
const LoadingScreen: React.FC<LoadingScreenProps> = ({ progress }) => {
  return (
    <div className="fixed inset-0 bg-[#000000] z-[9999] flex flex-col items-center justify-center overflow-hidden cursor-wait">
      <style>{`
        /* From Uiverse.io by Subaashbala - Adapted for THORX */ 
        .loader {
        ...
        .letter {
          width: fit-content;
          height: 4rem; /* Scaled up for full screen impact */
        }
